...
skill directory. It installs the skill and both custom-agent templates. Do not
run the installer silently during a task. See
`references/implementation-worker.toml` and
