...
The seven skill bodies are generated from the canonical Agent Plugins package
under [`plugins/portable/security/`](../../portable/security/) by
`.github/scripts/sync_skills.py`; do not edit this package's `skills/` tree
directly. This package's native manifest and marketplace entry are generated by
