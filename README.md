...
| [codex-maestro](plugins/codex/codex-maestro/) | Codex | `codex-maestro@agent-toolkit` | GPT-6 Sol/medium root orchestration with GPT-6 Luna/max workers for bounded implementation and exploration. |
